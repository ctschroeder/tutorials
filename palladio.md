...
This tutorial is a revised version of Miriam Posner's ["Getting started with Palladio" tutorial](https://github.com/miriamposner/palladio_workshop).  [Licensed CC-BY-NC](https://creativecommons.org/licenses/by-nc/4.0/).
