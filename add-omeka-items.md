...
This tutorial was created by Caroline T. Schroeder, licensed [CC-BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/). Last updated 9 September 2021.
...
Fill out the boxes that appear under this tab
   ...
   * Title: what is the title of your archive?

   * Subject: is the subject of the archive
   
   * Description: EITHER describe the archive in your own words OR copy a description from your source itself. If you copy and paste, put the description in quotes, and add a link to the site with the description you copied
   ...
   * Date: you can leave this blank unless you have a photograph or website that has a clear date; if you have a clear date enter it as YYYY-MM-DD or just YYYY for year
      ...
      * If your item is a photograph of an archive, you may wish to include the date of the image (also called a surrogate) as one entry and the date of the original object as another entry. If so, click “Add Input” to add a second entry box.
   ...
   * Language: what language is the archive?

   * Type: what kind of archive is this?
 ...
 * Fix everything needing fixing: click Edit and make necessary changes.
 
 ## 6. Go back and [redo Steps 4-5](https://github.com/ctschroeder/tutorials/blob/master/add-omeka-items.md#4-add-your-items-to-our-omeka-site) for your second archive.
